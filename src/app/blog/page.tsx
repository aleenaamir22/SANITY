...
import author from "../../../public/bd781b7b-49b6-4e1b-bbfe-3bbcaa399bd8.jpg";
  ...
  return (
    <article className="mt-12 mb-24 px-2 2xl:px-12 flex flex-col gap-y-8">
      ...
      <h1 className="text-xl xs:text-3xl lg:text-5xl font-bold text-dark dark:text-light">
        Unlocking the Future: Why Artificial Intelligence is Essential for Everyone
      </h1>
      ...
      <section className="px-2 sm:px-8 md:px-12 flex gap-2 xs:gap-4 sm:gap-6 items-start xs:items-center justify-start">
        ...
        <div className="flex flex-col gap-1">
          <h3 className="text-xl font-bold text-dark dark:text-light">NEIL</h3>
